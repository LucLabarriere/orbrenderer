...
namespace orb::vk
{
    ...
    public:
        ...
        auto buffer_usage_flag(buffer_usage_flags::enum_t flag) -> index_buffer_builder_t&
        {
            m_create_info.usage |= flag;
            return *this;
        }

        auto memory_usage(vma_mem_usages::enum_t usage) -> index_buffer_builder_t&
        {
            m_alloc_info.usage = usage;
            return *this;
        }

        auto memory_flags(vma_alloc_flags::enum_t flags) -> index_buffer_builder_t&
        {
